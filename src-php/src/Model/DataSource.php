...
class DataSource
{
    ...
    public const SOURCE_WSV_API = 20;
    public const SOURCE_AMPEQ_API = 25;
    ...
    public static function fromWSVApi(): self
    {
        return new self(self::SOURCE_WSV_API);
    }

    public static function fromAmpeqApi(): self
    {
        return new self(self::SOURCE_AMPEQ_API);
    }
